      ...
      <div id="about" className="aboutContainer">
        ...
        <div className="ParaBox">
          ...
          <p className="aboutMePara">
            ...
            I specialize in using HTML, CSS, and JavaScript, React.js, React Native 
            and more to bring ideas to life. I also have experience working with frameworks like React to build
