...
function Education() {
  ...
  return (
    ...
    >
      ...
      <div className="eduBox">
        <p className="eduPara">
          <strong>Governors State University</strong> <br />
          -Completed [X] Credits Toward Bachelor’s Degree. <br />
          -Completed multiple coding boot camps and self-taught projects. <br />
          -Certificate Of Completion from the <strong>Odin Project</strong> 
        </p>
      </div>
