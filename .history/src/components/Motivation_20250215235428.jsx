  ...
  return (
    ...
    >
      ...
      <div className="motivationBox">
        ...
        visually engaging product—whether it's a sleek portfolio, a business website, or a dynamic web app. Web development empowers me to solve real problems while expressing creativity through UI/UX design and modern frameworks.
        </p>
      </div>
