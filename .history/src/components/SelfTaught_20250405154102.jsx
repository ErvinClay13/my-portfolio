...
function SelfTaught() {
  ...
  return (
    ...
    >
      ...
      <div className="selfBox">
        <p className="selfPara">
          My journey into web development began with curiosity and a drive to learn,
          which quickly evolved into a love for crafting dynamic and responsive designs.
          As a self-starter, I thrive on solving problems and continuously expanding my
          skills to stay current with emerging technologies. I'm excited to contribute
          my creativity and technical skills to bring innovative projects to life while
          growing within the ever-evolving tech industry.
        </p>
      </div>

      <div className="selfBar">
        <img className="selfImg" src={selfTaught2} alt="Self-Taught Progress 1" />
        <img className="selfImg" src={selfTaught} alt="Self-Taught Progress 2" />
      </div>
    </motion.div>
  );
}
